...
#################################################################
def satisfy_dates(inventory_loc: str = "/om2/user/gkml/FieteLab-Recursive-Nonstationary-CRP/exp2_climate/ghcnd-inventory.txt",
                  end_year: int = 2020):
    ...
    with open("/om2/user/gkml/FieteLab-Recursive-Nonstationary-CRP/exp2_climate/sites_with_valid_dates_"+str(end_year)+".txt","w+") as f:
...
def get_qualifying_sites(end_year: int = 2020):
    ...
    with open('/om2/user/gkml/FieteLab-Recursive-Nonstationary-CRP/exp2_climate/sites_with_valid_dates_'+str(end_year)+'.txt') as file:
    ...
    with open("/om2/user/gkml/FieteLab-Recursive-Nonstationary-CRP/exp2_climate/qualifying_sites_"+str(end_year)+".txt","w+") as f:
        for site_csv_path in qualifying_sites:
            f.write(site_csv_path+"\n")
    f.close()

    with open("/om2/user/gkml/FieteLab-Recursive-Nonstationary-CRP/exp2_climate/qualifying_site_links_"+str(end_year)+".txt","w+") as f:
