...
def run_inference_alg(inference_alg_str: str,
    ...
    if model_str == 'linear_gaussian':
        ...
        if inference_alg_str.startswith('Doshi-Velez'):
            ...
            inference_alg = rncrp.prob_models.linear_gaussian.DoshiVelezLinearGaussian(
                model_str=model_str,
            ...
            inference_alg = rncrp.prob_models.linear_gaussian.RecursiveIBPLinearGaussian(
                model_str=model_str,
                gen_model_params=gen_model_params,
                plot_dir=None,
                # plot_dir=plot_dir,
            ...
            gen_model_params['t0'] = 0
            gen_model_params['kappa'] = 0.
            inference_alg = rncrp.prob_models.linear_gaussian.WidjajaLinearGaussian(
                model_str=model_str,
                gen_model_params=gen_model_params,
                use_infinite=True if 'Infinite' in inference_alg_str else False)
        elif inference_alg_str.startswith('HMC-Gibbs'):
            inference_alg = rncrp.prob_models.linear_gaussian.HMCGibbsLinearGaussian(
                model_str=model_str,
                gen_model_params=gen_model_params,
        ...
        if inference_alg_str == 'R-IBP':
            inference_alg = rncrp.prob_models.factor_analysis.RecursiveIBPFactorAnalysis(
                model_str=model_str,
                gen_model_params=gen_model_params,
                plot_dir=None,
