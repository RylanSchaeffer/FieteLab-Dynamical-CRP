###### Extinction-Reconsolidation Boundaries: Key to Persistent Attenuation of Fear Memories, Monfils et al., 2009
...
###### Format of Values
# A tuple whose length is a multiple 6. The events, tests, extinctions, or recalls that occur in the trial are specified in sequential order, 
# with each represented by 6 numerical values indicating: 
# Time, Type, Stimulus ID, Number of CS, Shock, Response
# Time: Hours since time 0, with time 0 = start of first event in experiment
# Type: 0=Fear Conditioning, 1=Test, 2=Retrieval, 3=Extinction, 4=Exposure, 5=LTM Test, 6=Nothing
# Stimulus ID: 0=No sound/nothing, 1=Context A, 2=Context B
# Number of CS: 1, 2, 3, 4, or 5, -1=not applicable
...
# Figure1
# No Ret
“1-1”: (0,0,1,1,1,-1,	24,3,1,1,0,19,	48,5,1,1,0,25,	768,1,1,1,0,38),
# Ret, 10min
“1-2”: (0,0,1,1,1,-1,	24,2,1,1,0,-1,	24.1667,3,1,1,0,21,	48.1667,5,1,1,0,26,	768.1667,1,1,1,0,26),
# Ret, 1hr
...
# Figure6
# No Ret
“6-1”: (0,0,1,5,1,-1,		24,6,1,1,0,-1, 	25,3,1,1,0,-1,	49,0,1,1,1,15,	49,0,1,1,1,53,	49,0,1,1,1,50,	49,0,1,1,1,65,	49,0,1,1,1,50),
# Ret, 1hr
“6-2”: (0,0,1,5,1,-1,		24,2,1,1,0,56,	25,3,1,1,0,-1,	49,0,1,1,1,10, 	49,0,1,1,1,26,	49,0,1,1,1,37,	49,0,1,1,1,34,	49,0,1,1,1,35)
}