...
plot_mixture_of_gaussians_debug.plot_scores_by_obs_dim_split_by_hyperparameter_choices(
    sweep_results_df=sweep_results_df,
    plot_dir=sweep_results_dir_path,
)

plot_mixture_of_gaussians_debug.plot_scores_by_snr_split_by_hyperparameter_choices(
    sweep_results_df=sweep_results_df,
    plot_dir=sweep_results_dir_path,
)
...
print(f'Finished 09_mixture_of_gaussians_debug/analyze_sweep.py for sweep={sweep_name}.')
